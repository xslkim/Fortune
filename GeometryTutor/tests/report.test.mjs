...
function sampleData() {
  ...
  return {
    ...
    categoryOf: (id) => ({ q1: '展开图', q2: '展开图', q3: '结构', q4: '结构', q5: '截面', q6: '截面' })[id],
    categories: ['结构', '展开图', '截面'],
    lessonsDone: 2,
    lessonsTotal: 7,
    mastery: applyAnswer(applyAnswer(applyAnswer({}, '结构', true, '2026-09-08'), '结构', true, '2026-09-08'), '结构', true, '2026-09-08'), // chain 3 → ★★☆
    streak: { current: 5 },
  };
}
...
test('buildReport：本周无记录时的空态与容错', () => {
  const r = buildReport({ attempts: [], categories: ['结构'], lessonsDone: 0, lessonsTotal: 7, mastery: {}, streak: null }, '2026-09-13');
