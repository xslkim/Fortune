...
import { recordActivity, goalProgress, emptyStreak, FREEZES_PER_MONTH } from '../src/engine/streak.js';
...
test('玩 1 关闯关即达成今日目标；与答题路径互相独立', () => {
  ...
  const legacy = recordActivity({ today: { date: '2026-09-10', steps: 0, answers: 2 } }, 'answer', '2026-09-10');
