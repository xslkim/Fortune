// 题库：120 题（q01-q120，8 大章节分类；每题 lessonIds 关联课程，难度 1-3 梯度分布）。
// 三种题型（type 字段，缺省 'choice'；注册表见 src/question-types.js）：
//   choice  四选一：answer:{ type:'choice', options:[4 项], correct:索引 }（q01-q100）
//   judge   判断题：answer:{ correct:0|1 }（1=正确，0=错误；选项 ['正确','错误'] 由注册表提供，q101-q110）
//   fill    填空题：answer:{ answers:[非空字符串], numeric?:true }（q111-q120 均 numeric:true）
// 每题 explain 至少 2 步：第 1 步给关键思路，第 2 步给完整计算/结论；难度 3 的题固定第 3 步补充易错点（audio 为 null）。
//
// ===== 每题验算过程（出题人自验）=====
...
export const QUIZZES = [
  {
    ...
    solid: 'cube',
    difficulty: 1,
    lessonIds: ['solid-basic'],
    question:
      '正方体的棱长为 2，则它的一个面的<b>面对角线</b>（如前图中 AB<sub>1</sub>）的长为多少？',
    scene: {
      highlight: {
        points: ['A', 'B1'],
        edges: [
    ...
    explain: [
      {
        ...
        audio: 'q02-ex1',
        scene: {
          highlight: { points: ['P', 'A'], edges: [['A', 'P']], faces: [] },
          spin: true,
          section: null,
        },
      },
  ...
  },
  {
    ...
    solid: 'box',
    difficulty: 2,
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    ...
    explain: [
      {
        ...
        audio: 'q04-ex1',
        scene: {
          highlight: { points: [], edges: [], faces: [0, 1, 2] },
          spin: false,
          section: null,
        },
      },
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把母线 l = 5 当成高 h 代入会得 15π；母线只在求侧面积 S = πrl 时使用。3-4-5 三角形是用来沟通 r、h、l 的，体积公式里认准高 h。',
        audio: 'q08-ex3',
        scene: { highlight: { points: ['P'], edges: [], faces: [0] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    solid: 'cube',
    difficulty: 3,
    lessonIds: ['section-skill', 'sphere-section'],
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>误以为斜着切能切出更多边。每条截面边恰好落在正方体的一个面上，正方体只有 6 个面，所以截面边数至多为 6，七边形绝不可能。',
        audio: 'q09-ex3',
        scene: {
          highlight: { points: [], edges: [], faces: [0, 1, 2, 3, 4, 5] },
          spin: true,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把 48π 当成圆柱体积直接除以 3。同底等高时 V柱 = 3V锥，两者之和是 4 份锥体积：先算 V锥 = 48π ÷ 4 = 12π，再乘 3 得 V柱 = 36π。',
        audio: 'q10-ex3',
        scene: {
          highlight: { points: ['A', 'A1'], edges: [], faces: [0, 1] },
          spin: true,
  ...
  },
  {
    ...
    solid: 'cylinder',
    difficulty: 1,
    lessonIds: ['three-views'],
    question:
      '一个圆柱竖直放置（轴线竖直），它的主视图和左视图都是长方形，则它的<b>俯视图</b>是什么图形？',
  ...
  },
  {
    ...
    lessonIds: ['net-unfold'],
    question:
      '在正方体的展开图中，同一行（或同一列）上、<b>中间恰好隔一个正方形</b>的两个面，折叠后是？',
    scene: {
      highlight: { points: [], edges: [], faces: [2, 4] },
      spin: true,
      section: null,
      unfold: 1,
    },
  ...
  },
  {
    ...
    lessonIds: ['net-unfold'],
    question:
      '圆柱的底面半径为 1，高为 3。它的侧面展开图是一个长方形，这个长方形相邻两边的长分别是？',
  ...
  },
  {
    ...
    solid: 'cube',
    difficulty: 2,
    lessonIds: ['position-rel'],
    question:
      '在正方体 ABCD-A<sub>1</sub>B<sub>1</sub>C<sub>1</sub>D<sub>1</sub> 中，下列哪一对直线是<b>异面直线</b>？',
    scene: {
      highlight: {
        points: [],
        edges: [
  ...
  },
  {
    ...
    lessonIds: ['section-skill', 'sphere-section'],
    question:
      '圆锥的底面半径为 3，高为 4，母线长为 5。它的<b>轴截面</b>（过轴线的截面）的面积为多少？',
    scene: {
  ...
  },
  {
    ...
    lessonIds: ['position-rel'],
    question:
      '在正方体 ABCD-A<sub>1</sub>B<sub>1</sub>C<sub>1</sub>D<sub>1</sub> 中，与棱 AB 是<b>异面直线</b>的棱共有多少条？',
    scene: {
      highlight: {
        points: [],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>数异面直线时容易把与 AB 平行的 3 条（CD、A₁B₁、C₁D₁）或相交的 4 条（AD、AA₁、BC、BB₁）误算进去。用 12 − 1（本身）− 3（平行）− 4（相交）分类排除最稳妥。',
        audio: 'q25-ex3',
        scene: {
          highlight: {
            points: [],
  ...
  },
  {
    ...
    lessonIds: ['section-skill', 'sphere-section'],
    question:
      '棱长为 2 的正方体，用过底面对角线 AC 的竖直平面去截，截面（对角面 ACC<sub>1</sub>A<sub>1</sub>）的面积为多少？',
    scene: {
      highlight: {
        points: ['A', 'C', 'A1', 'C1'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把截面宽当成棱长 2、算成面积 4。沿对角面切时，截面水平宽度是底面对角线 AC = √(2²+2²) = 2√2，要先用勾股定理求，不能直接用棱长。',
        audio: 'q26-ex3',
        scene: {
          highlight: {
            points: ['A', 'C', 'A1', 'C1'],
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>漏掉中间项 Rr，错写成 ⅓πh(R²+r²)。圆台公式是"上平方、上乘下、下平方"三项，可用"大圆锥减小圆锥"推导记忆，别只背两项。',
        audio: 'q27-ex3',
        scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    question:
      '一个"粮仓"由下方的圆柱与上方的圆锥组成：圆柱底面半径 2、高 3，圆锥与圆柱同底、高也是 3。这个组合体的体积为多少？',
    scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
    answer: {
      type: 'choice',
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>圆锥部分忘除 3，算成 12π + 12π = 24π。拆分后每部分仍要各自套对公式：圆柱 12π 加上圆锥 ⅓ × 12π = 4π，合计 16π。',
        audio: 'q28-ex3',
        scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>直接以棱长 1 为直径求 R。三条侧棱两两垂直的三棱锥可补成棱长 1 的正方体，二者外接球相同，直径 = 体对角线 √3，R = √3/2。',
        audio: 'q29-ex3',
        scene: {
          highlight: { points: ['A', 'B', 'C', 'P'], edges: [], faces: [0] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    question:
      '在棱长为 2 的正方体中，沿竖直方向挖去一个半径为 1、上下贯通的圆柱形孔。剩余部分的体积为多少？',
    scene: { highlight: { points: [], edges: [], faces: [1] }, spin: true, section: null },
    answer: {
      type: 'choice',
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>看到"挖孔"就去算孔壁侧面积。题目问剩余<b>体积</b>，只需 8 − 2π；只有问表面积时才需要补上孔壁 2π。动笔前先圈出题目问的是体积还是表面积。',
        audio: 'q30-ex3',
        scene: { highlight: { points: [], edges: [], faces: [1] }, spin: true, section: null },
      },
    ],
  ...
  },
  {
    ...
    lessonIds: ['three-views'],
    question:
      '一个几何体由棱长为 1 的小正方体搭成。俯视图是 2 × 2 的四个格子，格子上标注的层数分别为 1、2、2、3。这个几何体共有多少个小正方体？',
    scene: {
    ...
    explain: [
      {
        ...
        audio: 'q33-ex1',
        scene: {
          highlight: { points: [], edges: [], faces: [0] },
          spin: true,
          section: null,
          views: true,
        },
  ...
  },
  {
    ...
    solid: 'cube',
    difficulty: 1,
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体中，以 D 为原点，DA、DC、DD<sub>1</sub> 方向分别为 x、y、z 轴建立坐标系。则顶点 C<sub>1</sub> 的坐标是？',
    scene: {
      highlight: {
        points: ['D', 'C', 'C1'],
        edges: [
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '平面 α 内有两条相交直线，方向向量分别为 u = (1, 0, 0)、v = (0, 1, 1)。下列向量中，是平面 α 的法向量的是？',
    scene: {
      highlight: {
        points: ['D'],
        edges: [
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '以 D 为原点、DA/DC/DD<sub>1</sub> 为 x/y/z 轴（棱长 2）。体对角线向量 AC<sub>1</sub> 的坐标是？',
    scene: {
      highlight: { points: ['A', 'C1'], edges: [['A', 'C1']], faces: [] },
      spin: true,
      section: null,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把线面角公式与线线角混淆，用 cos 计算。线面角 θ 满足 sin θ = |v·n|/(|v||n|)；且线面角范围是 [0°, 90°]，结果直接取锐角，无需讨论补角。',
        audio: 'q41-ex3',
        scene: {
          highlight: {
            points: ['A', 'C', 'C1'],
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>算出 |cos| = √2/2 后不判断二面角是锐是钝。法向量夹角与二面角可能互补；本题由几何验证 ∠C₁BC = 45°，确为锐二面角。',
        audio: 'q42-ex3',
        scene: {
          highlight: {
            points: ['B', 'C', 'C1'],
  ...
  },
  {
    ...
    lessonIds: ['three-views'],
    question:
      '某几何体的主视图和左视图都是长方形，俯视图是<b>圆环</b>（两个同心圆）。这个几何体是？',
    scene: {
      highlight: { points: [], edges: [], faces: [1] },
      spin: true,
      section: null,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>算出点积为 0 后又去算夹角绕弯子。判垂直只需证 a·b = 0；写向量坐标时先口算符号再动笔，避免移项抄错。',
        audio: 'q45-ex3',
        scene: {
          highlight: {
            points: ['D', 'B1', 'A', 'C'],
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体中，异面直线 A<sub>1</sub>B 与 B<sub>1</sub>C（都是面对角线）所成角的大小为？',
    scene: {
      highlight: {
        points: ['A1', 'B', 'B1', 'C'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>异面直线所成角规定取<b>锐角或直角</b>，cos 要加绝对值；若算出负值，所成角仍是其对应的锐角（60° 而非 120°）。',
        audio: 'q47-ex3',
        scene: {
          highlight: {
            points: ['A1', 'B', 'D'],
  ...
  },
  {
    ...
    lessonIds: ['three-views'],
    question:
      '某几何体的三视图中，主视图是"下方长方形（宽 2、高 2）+ 上方三角形（底 2、高 3）"的组合，左视图相同，俯视图是带中心点的圆。该几何体的体积为？',
    scene: {
      highlight: { points: [], edges: [], faces: [0, 1] },
      spin: true,
      section: null,
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把组合体当成整体找一个"统一公式"。先由俯视图定部件：下方圆柱 V = 2π，上方圆锥 V = ⅓π = π；注意圆锥部分要除 3，合计 3π。',
        audio: 'q49-ex3',
        scene: {
          highlight: { points: [], edges: [], faces: [1] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体（D 为原点建系）中，体对角线 AC<sub>1</sub> 与平面 A<sub>1</sub>BD 的位置关系是？',
    scene: {
      highlight: {
        points: ['A1', 'B', 'D'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>只验证 AC₁ 垂直面内一条直线就下结论。必须垂直面内<b>两条相交</b>直线（DA₁ 与 DB 交于 D），线面垂直的判定才成立。',
        audio: 'q50-ex3',
        scene: {
          highlight: {
            points: ['A', 'C1', 'A1', 'B', 'D'],
  ...
  },
  {
    ...
    explain: [
      ...
      },
      {
        ...
        audio: 'q52-ex2',
        scene: {
          highlight: { points: ['A', 'B', 'C', 'D', 'P'], edges: [], faces: [] },
          spin: true,
          section: null,
        },
      },
  ...
  },
  {
    ...
    explain: [
      ...
      },
      {
        ...
        audio: 'q54-ex2',
        scene: {
          highlight: { points: [], edges: [], faces: [0, 1, 2, 3, 4, 5, 6, 7] },
          spin: true,
          section: null,
        },
      },
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把关系写成 2V = 3E。所有顶点的度数之和等于 2E（每条棱贡献 2 个端点）：3V = 24，V = 8；得出结果可用欧拉公式 V − E + F = 2 检验。',
        audio: 'q55-ex3',
        scene: {
          highlight: { points: ['A', 'B', 'C', 'D', 'A1', 'B1', 'C1', 'D1'], edges: [], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    question:
      '三棱锥 P-ABC 中，底面 ABC 的面积为 6，P 到底面的距离为 4。若以侧面 PAB（面积为 4）为底面，则 C 到平面 PAB 的距离是多少？',
    scene: {
      highlight: {
        points: ['A', 'B', 'C', 'P'],
        edges: [
    ...
    insight: '等体积换底：h = 3V/S，把 3 乘回去',
    explain: [
      {
        text: '<b>关键思路</b>：<b>等积变换</b>——同一个三棱锥，换不同的面当底，体积不变。先以 ABC 为底算出体积。',
        audio: 'q60-ex1',
        scene: {
          highlight: { points: ['A', 'B', 'C'], edges: [], faces: [0] },
          spin: true,
          section: null,
        },
      },
      ...
      {
        text: '<b>易错点：</b>换底后忘乘 3，写成 h = V/S = 2。锥体体积 V = Sh/3，反解高是 h = 3V/S：V = 8 不变，h = 3 × 8 ÷ 4 = 6。"除以 3 要记得乘回来"是锥体题的命门。',
        audio: 'q60-ex3',
        scene: {
          highlight: {
            points: ['A', 'B', 'P'],
  ...
  },
  {
    ...
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    question:
      '一个圆柱形水桶，底面半径 2 dm，高 5 dm。它最多能装水约多少升？（π 取 3.14，1 升 = 1 立方分米）',
    scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
    answer: {
      type: 'choice',
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>笔筒<b>无盖</b>，材料 = 一个底面 π + 侧面 8π = 9π；按完整圆柱算成 10π 就错了。遇到"无盖、无底、贴墙"等关键词，先想清楚哪些面不算。',
        audio: 'q62-ex3',
        scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    lessonIds: ['prism-volume', 'pyramid-volume', 'cylinder-cone'],
    question:
      '在棱长为 2 的正方体上表面中央，放一个底面半径为 1、高为 1 的圆柱（底面贴合）。这个组合体的表面积是多少？',
    scene: { highlight: { points: [], edges: [], faces: [1] }, spin: true, section: null },
    answer: {
      type: 'choice',
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>圆柱底面圆的处理易错：贴合处大正方体被盖住 π，同时圆柱上底又露出 π，恰好抵消；净效果只在 24 上加圆柱侧面积 2π。别只减不加，或重复计算底面。',
        audio: 'q63-ex3',
        scene: { highlight: { points: [], edges: [], faces: [0, 1] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>算出截面圆半径 4 就直接作答。注意公式是 r² = R² − d²（R 为球半径，d 为球心到截面距离），且题目问的是面积：S = πr² = 16π，别忘了乘 π。',
        audio: 'q64-ex3',
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: true, section: null },
      },
    ],
  },
  {
    ...
    explain: [
      ...
      },
      {
        ...
        audio: 'q65-ex2',
        scene: {
          highlight: { points: ['P'], edges: [], faces: [0, 1, 2, 3, 4] },
          spin: true,
          section: null,
        },
      },
      {
        text: '<b>易错点：</b>把斜高与棱锥的高混淆。本题侧面三角形的高（斜高）就是 2，每个侧面面积 = ½ × 2 × 2 = 2，四个共 8，加底面 4，S = 12。',
        audio: 'q65-ex3',
        scene: {
          highlight: { points: ['P'], edges: [], faces: [0, 1, 2, 3, 4] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['net-unfold'],
    question:
      '一只蚂蚁从正方体（棱长 2）顶点 A 出发，<b>沿表面</b>爬到对角顶点 C<sub>1</sub>。最短路径的长度是多少？',
    scene: {
      highlight: { points: ['A', 'C1'], edges: [], faces: [] },
      spin: true,
      section: null,
      unfold: 0,
    },
    ...
    insight: '曲面最短路径：展开摊平，直线相连',
    explain: [
      {
        text: '<b>关键思路</b>：沿表面的最短路线，<b>展开后就是直线</b>。把相邻的两个面摊平成一个长方形，蚂蚁走的是它的对角线。',
        audio: 'q66-ex1',
        scene: {
          highlight: { points: ['A', 'C1'], edges: [], faces: [2, 1] },
          spin: false,
          section: null,
          unfold: 0.5,
        },
      ...
      {
        text: '<b>易错点：</b>在立体表面直接"拉直线"。蚂蚁爬行的最短路线要把经过的面<b>展开成同一平面</b>再连直线：展开后长方形 2 × 4，对角线 2√5；不展开算出的空间直线是"穿墙"距离。',
        audio: 'q66-ex3',
        scene: {
          highlight: { points: ['A', 'C1'], edges: [['A', 'C1']], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['net-unfold'],
    question:
      '正方体"一四一"型展开图中，中间一行的四个正方形从左到右依次记为 ①②③④。折成正方体后，① 与 ③ 是？',
    scene: {
  ...
  },
  {
    ...
    lessonIds: ['net-unfold'],
    question:
      '圆柱的底面半径为 1，高为 3。一条细线从下底面某点出发，<b>绕侧面恰好一周</b>到达正上方对应点。细线的最短长度是多少？',
    scene: {
      highlight: { points: ['A', 'A1'], edges: [], faces: [] },
      spin: true,
      section: null,
      unfold: 0,
    },
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把绕侧面的曲线当成平面上的圆来算。沿母线剪开圆柱侧面，摊平后是长方形：一边为高 3，另一边为底面周长 2π，细线最短 = 对角线 √(4π² + 9)。',
        audio: 'q69-ex3',
        scene: {
          highlight: { points: ['A', 'A1'], edges: [['A', 'A1']], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['three-views'],
    question:
      '一个由小正方体搭成的几何体，俯视图是 2 × 2 的格子，各格层数为：前排 1、2，后排 2、3。从正面看，主视图两列的高度分别是？',
    scene: {
      highlight: { points: [], edges: [], faces: [1] },
      spin: true,
      section: null,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>由主视图读出底边 4、高 3 后忘除 3，算成 48。还原几何体后仍要回到对应公式：V = 16 × 3 ÷ 3 = 16。',
        audio: 'q72-ex3',
        scene: {
          highlight: {
            points: ['P'],
  ...
  },
  {
    ...
    lessonIds: ['three-views'],
    question:
      '一个长方体的三视图分别是：主视图 3 × 2、左视图 4 × 2、俯视图 3 × 4 的长方形。它的表面积是多少？',
    scene: {
      highlight: { points: [], edges: [], faces: [0, 1, 2, 3, 4, 5] },
      spin: true,
      section: null,
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把三个视图的面积相加当成表面积。三视图提供的是尺寸信息：还原长方体 3 × 4 × 2 后，S = 2 × (12 + 8 + 6) = 52。',
        audio: 'q73-ex3',
        scene: {
          highlight: { points: [], edges: [], faces: [0, 1, 2, 3, 4, 5] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['section-skill', 'sphere-section'],
    question:
      '用平行于轴线的平面截半径为 2 的圆柱，平面到轴线的距离为 1，圆柱高为 3。截面（长方形）的面积是多少？',
    scene: {
      highlight: { points: [], edges: [], faces: [] },
      spin: true,
      section: { n: [1, 0, 0], d: 1 },
  ...
  },
  {
    ...
    lessonIds: ['section-skill', 'sphere-section'],
    question:
      '棱长为 2 的正方体中，过棱 AB 的中点、棱 AD 的中点作一个<b>竖直</b>（平行于侧棱）的截面。截面面积是多少？',
    scene: {
      highlight: {
        points: ['A', 'B', 'D'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>截面是竖直长方形而非三角形：水平边是底面上两个中点的连线 = √2，竖直边长为棱长 2，面积 = √2 × 2。别按三角形面积公式算，也别把宽当成棱长的一半 1。',
        audio: 'q76-ex3',
        scene: {
          highlight: { points: ['A'], edges: [['A', 'A1']], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>高取一半就以为面积也取一半得 ½。相似图形面积比是相似比的<b>平方</b>：中点处相似比 1/2，面积比 1/4；体积比才是立方（1/8），三者别混。',
        audio: 'q78-ex3',
        scene: {
          highlight: { points: ['P'], edges: [], faces: [0] },
          spin: true,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>AB 与 A₁C₁ 异面，找不到交点就不知从何下手。把 A₁C₁ 平移到 AC（上、下底面对角线互相平行），AB 与 AC 是等腰直角三角形的两腰，所成角 45°；平移不改变方向。',
        audio: 'q82-ex3',
        scene: {
          highlight: {
            points: ['A'],
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>由 a ∥ α 直接断言 a 平行 α 内任意直线。线面平行只说明 a 与平面没有公共点；α 内的 b 与 a 可能平行，也可能异面，两种都要讨论。',
        audio: 'q83-ex3',
        scene: {
          highlight: {
            points: [],
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>把线面角当成直线与竖直方向的夹角。B₁D 与底面所成角要看 B₁D 与其<b>投影</b> BD 的夹角：tan θ = 竖直落差 B₁B ÷ 投影长 BD = 2/(2√2) = √2/2。',
        audio: 'q88-ex3',
        scene: {
          highlight: { points: ['B1', 'D'], edges: [['B1', 'D']], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>分母用错：侧面与底面所成二面角的平面角，一条直角边是底面中心到边中点的距离 1（不是到顶点的 √2）。tan θ = 高 1 ÷ 1 = 1，θ = 45°。',
        audio: 'q89-ex3',
        scene: {
          highlight: {
            points: ['P'],
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体，以 D 为原点、DA/DC/DD<sub>1</sub> 为 x/y/z 轴建系。棱 BC 的中点坐标是？',
    scene: {
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体（D 为原点建系）中，用向量法判断：侧棱 AA<sub>1</sub> 与底面对角线 BD 的位置关系是？',
    scene: {
      highlight: {
        points: ['A', 'A1', 'B', 'D'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>以为异面直线不能谈垂直。空间中两直线所成角由方向向量决定：AA₁ = (0,0,2)、BD = (−2,−2,0)，点积为 0，所成角 90°，异面垂直成立。',
        audio: 'q95-ex3',
        scene: {
          highlight: {
            points: ['A', 'A1', 'B', 'D'],
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体（D 为原点建系）中，体对角线 DB<sub>1</sub> 与底面 ABCD 所成角的正弦值是？',
    scene: {
      highlight: {
        points: ['D', 'B', 'B1'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>公式记混：线面角用 sin θ = |v·n|/(|v||n|)，线线角才用 cos。DB₁ = (2,2,2) 配底面法向量 (0,0,1)，sin θ = 2/(2√3) = √3/3。',
        audio: 'q96-ex3',
        scene: {
          highlight: {
            points: ['D', 'B', 'B1'],
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体（D 为原点建系）中，平面 A<sub>1</sub>BD 与底面 ABCD 所成二面角的余弦值（取锐角）是？',
    scene: {
      highlight: {
        points: ['A1', 'B', 'D'],
        edges: [
    ...
    insight: '二面角 = 法向量夹角，取锐角直接开 arccos',
    explain: [
      {
      ...
      {
        text: '<b>易错点：</b>法向量夹角与二面角可能互补。本题取锐角，|cos| = √3/3 即答案；若题目所给图形显示二面角为钝角，则要取补角。',
        audio: 'q97-ex3',
        scene: {
          highlight: {
            points: ['A1', 'B', 'D'],
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '正方体（D 为原点建系）的侧面 DAA<sub>1</sub>D<sub>1</sub> 内有两条棱方向为 DA = (2,0,0)、DD<sub>1</sub> = (0,0,2)。该侧面的一个法向量是？',
    scene: {
      highlight: {
        points: ['D'],
        edges: [
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体（D 为原点建系）中，E 为棱 DD<sub>1</sub> 的中点。则 cos〈AE, AC<sub>1</sub>〉 = ？',
    scene: {
      highlight: {
        points: ['A', 'D', 'D1', 'C1'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>向量方向写错：AE = E − A = (−2,0,1)（终点减起点），写成 EA 会使点积变号。本题虽取绝对值结果不变，但遇到钝角判定就会出错；E 是中点，坐标别忘除以 2。',
        audio: 'q99-ex3',
        scene: {
          highlight: { points: ['A', 'C1'], edges: [['A', 'C1']], faces: [] },
          spin: true,
  ...
  },
  {
    ...
    lessonIds: ['vector-basic', 'vector-angle'],
    question:
      '棱长为 2 的正方体中，平面 A<sub>1</sub>BD 恰好经过顶点 A 的三个相邻顶点，截去三棱锥 A-A<sub>1</sub>BD。截去部分的体积是多少？',
    scene: {
      highlight: {
        points: ['A', 'A1', 'B', 'D'],
        edges: [
    ...
    explain: [
      ...
      {
        text: '<b>易错点：</b>底面选错硬算：截下的三棱锥以直角顶点 A 为顶、三条两两垂直的棱为棱，V = (1/3) × (½ × 2 × 2) × 2 = 4/3。记住墙角模型 V = abc/6，考试直接用。',
        audio: 'q100-ex3',
        scene: {
          highlight: {
            points: ['A', 'A1', 'B', 'D'],
  ...
  // ===== q101-q110 判断题（judge）：answer:{ correct:0|1 }，1=正确、0=错误；选项由注册表提供 =====
  // ===== q111-q120 填空题（fill）：answer:{ answers:[...], numeric:true } =====
  {
    id: 'q101',
    category: '位置关系',
    title: '不相交即异面？',
    ...
    difficulty: 1,
    lessonIds: ['position-rel'],
    question: '判断正误：正方体中，<b>不相交</b>的两条棱一定是异面直线。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 0 },
    explain: [
      {
        text: '<b>关键思路</b>：两条直线不相交，除了异面之外还有一种可能——<b>平行</b>。平行直线在同一平面内且永不相交。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：正方体中 AB 与 CD 不相交，但它们是<b>平行</b>直线，不是异面直线。故该命题<b>错误</b>。',
        audio: null,
        scene: {
          highlight: {
            points: ['A', 'B', 'C', 'D'],
  ...
  },
  {
    ...
    difficulty: 1,
    lessonIds: ['position-rel'],
    question: '判断正误：过直线外一点，<b>有且只有一条</b>直线与已知直线平行。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 1 },
    explain: [
      {
        text: '<b>关键思路</b>：这是立体几何的平行公理（欧几里得第五公设的推论），在平面和空间中都成立。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：存在性（至少一条）与唯一性（至多一条）都可证明：若有两条都过该点且与原直线平行，则它们互相平行，但又有公共点，矛盾。故该命题<b>正确</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    lessonIds: ['parallel-perp'],
    question:
      '判断正误：如果一条直线垂直于平面内的<b>两条相交直线</b>，那么这条直线垂直于这个平面。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 1 },
    explain: [
      {
        text: '<b>关键思路</b>：这正是线面垂直的判定定理——注意条件是"两条<b>相交</b>直线"，"相交"三个字缺一不可。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：设 l⊥a、l⊥b 且 a∩b=P，则平面内任一向量都可由 a、b 的方向向量线性表出，l 的方向与它们点积均为 0，故 l 垂直平面内所有直线，即 l⊥α。命题<b>正确</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['parallel-perp'],
    question: '判断正误：垂直于同一条直线的两条直线<b>一定互相平行</b>。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 0 },
    explain: [
      {
        text: '<b>关键思路</b>：在空间中"垂直"包括<b>异面垂直</b>，两条直线都垂直于同一条直线，它们之间可能平行、相交或异面。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>反例</b>：正方体中 AB、AD 都垂直于 AA<sub>1</sub>，但 AB 与 AD <b>相交</b>于 A；AD 与 BB<sub>1</sub> 都垂直于 AB 所在的底面方向，却互为异面直线。故该命题<b>错误</b>。',
        audio: null,
        scene: {
          highlight: {
            points: ['A', 'B', 'D', 'A1'],
  ...
  },
  {
    ...
    difficulty: 1,
    lessonIds: ['net-unfold'],
    question: '判断正误：正方体的表面展开图由 <b>6 个正方形</b>组成。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 1 },
    explain: [
      {
        text: '<b>关键思路</b>：展开图是把几何体的表面沿若干条棱剪开后摊平得到的图形，正方体有 6 个面，每个面都是正方形。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：6 个面沿棱剪开摊平后正好是 6 个正方形相连（本质不同的连法共 11 种）。故该命题<b>正确</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['net-unfold'],
    question: '判断正误：任意 6 个正方形连在一起，都<b>一定能</b>折成正方体。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 0 },
    explain: [
      {
        text: '<b>关键思路</b>：能折成正方体的六连方只有 <b>11 种</b>；含"田"字形、"凹"字形等连法折叠时会有两个面重叠。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：例如 4 个正方形拼成"田"字、上下各再接一个，折叠时"田"字部分无法围成 4 个侧面。故该命题<b>错误</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 1,
    lessonIds: ['three-views'],
    question: '判断正误：球的<b>三视图都是圆</b>。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 1 },
    explain: [
      {
        text: '<b>关键思路</b>：三视图是从前、左、上三个方向投影。球无论从哪个方向看，轮廓都是半径相同的圆。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：球心在三个投影面上的投影都是圆心，半径都等于球的半径 R，故主视图、左视图、俯视图是全等的圆。命题<b>正确</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['three-views'],
    question: '判断正误：一个几何体的主视图和俯视图都是长方形，它<b>一定</b>是长方体。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 0 },
    explain: [
      {
        text: '<b>关键思路</b>：三视图反映的是轮廓，不同的几何体可能有相同的视图——圆柱横放时主视图和俯视图都可以是长方形。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>反例</b>：把圆柱的轴水平放置（侧放），从正面和上面看轮廓都是长方形。它显然不是长方体。故该命题<b>错误</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 1,
    lessonIds: ['solid-basic'],
    question: '判断正误：棱柱的侧面都是<b>平行四边形</b>。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 1 },
    explain: [
      {
        text: '<b>关键思路</b>：棱柱的定义是上下底面全等且平行，侧棱互相平行。每个侧面由两条侧棱和底面两条对应边围成。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：侧面的两组对边分别平行（侧棱互相平行，底面对应边互相平行），所以每个侧面都是平行四边形；直棱柱的侧面更是矩形。命题<b>正确</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['solid-basic'],
    question: '判断正误：欧拉公式"顶点数 − 棱数 + 面数 = 2"对<b>任意</b>多面体都成立。',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'judge',
    answer: { correct: 0 },
    explain: [
      {
        text: '<b>关键思路</b>：欧拉公式 V−E+F=2 只对<b>凸多面体</b>（以及与球拓扑等价的多面体）成立，"任意"二字过头了。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>反例</b>：救生圈形（环面）多面体，如上下相通的棱柱环，V−E+F=0 而不是 2。故该命题<b>错误</b>；记住欧拉公式的条件是凸多面体。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    solid: 'cube',
    difficulty: 2,
    lessonIds: ['prism-volume'],
    question: '正方体的棱长为 3，则它的体积为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['27'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：正方体是特殊的长方体，体积 = 棱长的立方。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：V = 3<sup>3</sup> = 3×3×3 = <b>27</b>。注意别和表面积 6×3² = 54 混淆。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['94'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：长方体有三组相对的全等面，表面积 = 2(长×宽 + 长×高 + 宽×高)。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：S = 2×(3×4 + 3×5 + 4×5) = 2×(12 + 15 + 20) = 2×47 = <b>94</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    solid: 'pyramid4',
    difficulty: 2,
    lessonIds: ['pyramid-volume'],
    question: '四棱锥的底面是边长为 4 的正方形，高为 3，则它的体积为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['16'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：锥体体积是同底等高柱体的三分之一：V = (1/3)×底面积×高。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：底面积 S = 4² = 16，V = (1/3)×16×3 = <b>16</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 3,
    lessonIds: ['prism-volume'],
    question: '已知一个正方体的<b>体积为 64</b>，则它的表面积为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['96'], numeric: true },
    insight: '由体积开立方得棱长，再由棱长算表面积',
    explain: [
      {
        text: '<b>关键思路</b>：逆向思考——体积 = 棱长³，先由体积开立方求出棱长，再算表面积 6×棱长²。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：棱长 a = ∛64 = 4，S = 6a² = 6×16 = <b>96</b>。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>易错点：</b>把 64 直接当棱长算表面积：∛64 = 4 而不是 64。记住 2³=8、3³=27、4³=64 这几个常见立方数。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    solid: 'cube',
    difficulty: 2,
    lessonIds: ['section-skill'],
    question: '用一个平面去截正方体，截面边数最多为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['6'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：截面的每一条边都是截面与几何体一个面的交线，正方体只有 6 个面。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>结论</b>：平面最多与 6 个面各交出一条边（如过 6 条棱中点的正六边形截面），所以边数最多为 <b>6</b>，不可能是七边形。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    solid: 'sphere',
    difficulty: 2,
    lessonIds: ['sphere-section'],
    question: '球的半径为 5，球心到截面的距离为 3，则截面圆的半径为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['4'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：球心、截面圆心、截面圆上一点构成直角三角形：球半径是斜边，满足 R² = d² + r²。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：r = √(R² − d²) = √(25 − 9) = √16 = <b>4</b>。球心到截面越近，截面圆越大。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    solid: 'cube',
    difficulty: 2,
    lessonIds: ['vector-basic'],
    question: '已知向量 a = (2, −1, 2)，b = (1, 2, −1)，则 a·b 的值为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['-2'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：点积是对应坐标乘积之和：a·b = a₁b₁ + a₂b₂ + a₃b₃。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：a·b = 2×1 + (−1)×2 + 2×(−1) = 2 − 2 − 2 = <b>−2</b>。结果为负说明两向量夹角是钝角。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['vector-basic'],
    question: '已知向量 a = (2, 1, 2)，则 |a| 的值为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['3'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：向量的模等于坐标平方和的算术平方根：|a| = √(a₁² + a₂² + a₃²)。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：|a| = √(2² + 1² + 2²) = √(4 + 1 + 4) = √9 = <b>3</b>。常见勾股数组 (2,1,2)→3、(1,2,2)→3 可以记住。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 2,
    lessonIds: ['solid-basic'],
    question: '一个凸多面体的顶点数为 6、面数为 5，则由欧拉公式可求得它的棱数为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['9'], numeric: true },
    explain: [
      {
        text: '<b>关键思路</b>：凸多面体满足欧拉公式 V − E + F = 2，把已知的 V、F 代入即可解出 E。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：E = V + F − 2 = 6 + 5 − 2 = <b>9</b>（正好就是三棱柱的棱数）。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
  },
  {
    ...
    difficulty: 3,
    lessonIds: ['solid-basic'],
    question: '一个凸多面体有 12 个顶点和 8 个面，则它的棱数为多少？',
    scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
    type: 'fill',
    answer: { answers: ['18'], numeric: true },
    insight: '欧拉公式变形：E = V + F − 2',
    explain: [
      {
        text: '<b>关键思路</b>：欧拉公式 V − E + F = 2 中三量知二求一，变形为 E = V + F − 2 直接代入。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>完整计算</b>：E = 12 + 8 − 2 = <b>18</b>（可以验证这正是六棱柱：12 顶点、8 面、18 棱）。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
      {
        text: '<b>易错点：</b>符号记错算成 E = V − F + 2 = 6：记住欧拉公式的标准写法是"顶点 + 面 − 棱 = 2"，棱数是被减的那一项。',
        audio: null,
        scene: { highlight: { points: [], edges: [], faces: [] }, spin: false, section: null },
      },
    ],
